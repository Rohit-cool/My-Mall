...
public class MainFragment extends Fragment {
    ...
    private void initView(View view) {
        ...
        newItemRecView = view.findViewById(R.id.newItemsRecView);
        popularItemRecView = view.findViewById(R.id.popularItemsRecView);
        suggestedItemRecView = view.findViewById(R.id.suggestedItemsRecView);
