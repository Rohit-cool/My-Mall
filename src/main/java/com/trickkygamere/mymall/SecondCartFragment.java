...
public class SecondCartFragment extends Fragment {
    ...
    private EditText edtTxtAddress, edtZipCode, edtPhone;
            ...
            public void onClick(View view) {
                if (validateData()) {
                    ...
                    if (null!= cartItems) {
                        ...
                        ThirdCartActivity thirdCartActivity = new ThirdCartActivity();
                        thirdCartActivity.setArguments(bundle);
                        FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                        transaction.replace(R.id.container, thirdCartActivity);
                        transaction.commit();
                    ...
                    txtWarning.setText("Plzz Fill All Blanks");
                }
            }
        });
        return view;
    ...
    private boolean validateData() {
        if (edtTxtAddress.getText().toString().equals("") || edtPhone.getText().toString().equals("")
